    ...
    return (
        <div>
            ...
            <div className="tabs tabs-box justify-center bg-transparent gap-3">
                ...
                <input onClick={()=> setTab(false)} type="radio" name="my_tabs_1" className={`tab w-40 rounded-full ${tab || 'bg-[#fb2c36] text-white' } font-bold`} aria-label={`Card (${addAi.length})`} />
            </div>
        </div>
    );
};
